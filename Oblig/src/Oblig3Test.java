...
public class Oblig3Test
{
    public static void main(String[] args)
    {
       ...
       antallFeil += oppgave10();
        ...
        {
            System.out.println
                    ("\nDette mÃ¥ forbedres. Du har minst " + antallFeil + " feil!");
        }
    }
...
// OPPGAVE 4 ////////////////////////////////////////////////
    ...
    public static int oppgave5()
    {
        ...
        {
            antallFeil++;
            System.out.println("Oppgave 5c: Feil i fjern(T)! Skal returnere false nÃ¥r");
        ...
        catch (Exception e)
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 5o: Skal ikke kaste unntak nÃ¥r et tomt tre nullstilles!");
        }
    ...
    public static int oppgave6()
    {
        ...
        if (!s.equals("[3, 8, 4, 7, 5, 6, 6]"))
        {
            ...
            System.out.println(" vÃ¦re [3, 8, 4, 7, 5, 6, 6].");
        }
        ...
        if (!s.equals("[4, 3, 2, 1]"))
        {
            ...
            System.out.println(" vÃ¦re [4, 3, 2, 1].");
        }
        ...
        if (!s.equals("[F, H, O, K, J, I]"))
        {
            ...
            System.out.println(" vÃ¦re [F, H, O, K, J, I].");
        }
    ...
    public static int oppgave8()
    {
        ...
        if (!s.equals("[10]"))
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 8ac: Feil - du har " + s + ", det skal vÃ¦re [10].");
        }
        ...
        if (!s.equals("[11]"))
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 8ad: Feil - du har " + s + ", det skal vÃ¦re [11].");
        }
        ...
        if (!s.equals("[6, 9, 12, 14, 16]"))
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 8ae: Feil - du har " + s + ", det skal vÃ¦re [6, 9, 12, 14, 16].");
        }
        ...
        if (!s.equals("[5]"))
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 8af: Feil - du har " + s + ", det skal vÃ¦re [5].");
        }
        ...
        if (!s.equals("[1]"))
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 8ag: Feil - du har " + s + ", det skal vÃ¦re [1].");
        }
        ...
        if (poststring.compareTo("[]") != 0)
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 8ba: Feil - du har " + poststring + ", det skal vÃ¦re [].");
        }
        ...
        if (poststring.compareTo("[10]") != 0)
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 8bb: Feil - du har " + poststring + ", det skal vÃ¦re [10].");
        }
        ...
        if (poststring.compareTo("[15, 10]") != 0)
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 8bc: Feil - du har " + poststring + ", det skal vÃ¦re [15, 10].");
        }
    ...
    public static int oppgave9()
    {
        ...
        try
        {
            i.next();
            antallFeil++;
            System.out.println("Oppgave 9a: Skal kaste unntak nÃ¥r treet er tomt!");
        }
        catch (Exception e)
        {
        ...
        try
        {
            ...
            antallFeil++;
            System.out.println
                    ("Oppgave 9d: Skal kaste unntak nÃ¥r det ikke er flere igjen!");
        }
        catch (Exception e)
        {
            if (!(e instanceof NoSuchElementException))
        ...
        if (!s.equals("[1, 3, 7, 9]"))
        {
            antallFeil++;
            System.out.println
                    ("Oppgave 9f: Feil - du har " + s + ", det skal vÃ¦re [1, 3, 7, 9].");
            System.out.println
                    ("            Din iterator skal kun gÃ¥ gjennom bladnodene!");
...
// OPPGAVE 10 ////////////////////////////////////////////////
    ...
    public static int oppgave10()
    {
        ...
        try
        {
            i.remove();
            antallFeil++;
            System.out.println("Oppgave 10a: Skal kaste unntak nÃ¥r treet er tomt!");
        }
        catch (Exception e)
        {
        ...
        try
        {
            ...
            if (tre.antall() != 8)
            {
                antallFeil++;
                System.out.println
                        ("Oppgave 10i: Feil - mÃ¥ ha antall-- i remove()!");
            }
        }
        catch (Exception e)
        {
